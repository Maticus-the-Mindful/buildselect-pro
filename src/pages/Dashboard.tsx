          ...
          <div className="bg-white dark:bg-slate-800 rounded-lg shadow-xl max-w-md w-full p-6">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                autoFocus
              />
              {deleteConfirmation !== projectToDelete.name && deleteConfirmation.length > 0 && (
                <p className="text-sm text-red-600 dark:text-red-400 mt-1">
                  Project name doesn't match. Please type exactly: <span className="font-mono font-medium">{projectToDelete.name}</span>
                </p>
              )}
            </div>
            ...
            <div className="flex gap-3 justify-end">
              ...
              <button
                ...
                title={deleteConfirmation !== projectToDelete.name ? "Please type the project name to enable deletion" : ""}
              >
                {deleting ? (
                  <>
